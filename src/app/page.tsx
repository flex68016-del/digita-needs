...
export default function Home() {
  ...
  const handleStepComplete = async (selected: string | string[]) => {
    ...
    const { data, error } = await supabase.rpc('submit_survey', {
      ...
      p_acquisition_methods: Array.isArray(updatedResponses[1]) ? updatedResponses[1] : [updatedResponses[1]],
      p_digital_tools: Array.isArray(updatedResponses[2]) ? updatedResponses[2] : [updatedResponses[2]],
      p_challenges: Array.isArray(updatedResponses[3]) ? updatedResponses[3] : [updatedResponses[3]],
      p_digital_needs: Array.isArray(updatedResponses[4]) ? updatedResponses[4] : [updatedResponses[4]],
